class Persona {
  ...
  toString() {
    return ` Persona: ${this.idPersona}, ${this._nombre} ${this._apellido}, Edad: ${this._edad}`;
  }
}
...
class Cliente extends Persona {
  ...
  toString() {
    return `${super.toString()} Cliente: ${this._idCliente}, Creado: ${this._fechaRegistro},`; 
  }
}

//Pruba de la clase persona
